  ...
  return (
    <Grid container spacing={3}>
      ...
      <Grid item xs={12} md={5} lg={4}>
        ...
        <ShippingAddressBox
          recipient_phone={orderInfo.recipient_phone}
          recipient_area={orderInfo.recipient_area}
          division={orderInfo.division.name}
          district={orderInfo.district.name}
          upazila={orderInfo.upazila.name}
          union={orderInfo.union}
        />
      </Grid>
    </Grid>
  );
