...
import z from "zod";
import registerImage from "../../assets/authentication/create1.png";
        ...
        <Box maxWidth={500}>
          <Stack mb={3} direction="column" gap={2}>
            ...
            <Typography
              ...
              fontSize={20}
            >
              Create Your Global Shop Account
            </Typography>
            <Typography component="p" variant="body1" fontSize={14}>
              Join Global Shop today! Create an account to start shopping, manage
